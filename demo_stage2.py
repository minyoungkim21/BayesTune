...
def run_simple(args: RunConfiguration, with_continue: bool = False):
    ...
    with distributed.only_first_process(local_rank=args.local_rank):
        ...
        phase_task_dict = {
            "train": args.train_tasks,  # ['cola']
            "val": args.val_tasks,  # ['cola']
            "test": args.test_tasks,  # ['cola']
        }
        for task_name in full_task_name_list:
            phases_to_do = []
    ...
    # We'll do this with a configurator. 
    # Creating a jiant_task_config has a surprising number of moving parts.
    ...
    if args.model_weights_path:
        ...
        # "from_transformers" or "from_transformers_with_mlm"
    ...
    run_args = my_runner2.RunConfiguration(
    ...
    my_runner2.run_loop(args=run_args, checkpoint=checkpoint)
